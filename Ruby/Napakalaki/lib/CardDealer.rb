...
class CardDealer
  ...
  def initMonsterCardDeck
    ...
    @unusedMonsters.push Monster.new('Byakhees de bonanza', 8, prize, bad_consequence)
    ...
    @unusedMonsters.push Monster.new('Tenochtitlan', 2, prize, bad_consequence)
    ...
    @unusedMonsters.push Monster.new('El sopor de dunwich', 2, prize, bad_consequence)
    ...
    @unusedMonsters.push Monster.new('Demonios de Magaluf', 2, prize, bad_consequence)
   ...
   # Monstruo 5 -> EL GORRON DEL UMBRAL
    ...
    @unusedMonsters.push Monster.new('H.P. Munchcraft', 6, prize, bad_consequence)
    ...
    @unusedMonsters.push Monster.new('Necrofago', 13, prize, bad_consequence)
    ...
    @unusedMonsters.push Monster.new('El rey de rosado', 11, prize, bad_consequence)

    # Monstruo 9 -> FLECHER
    prize = Prize.new(1, 1)
    bad_consequence = BadConsequence.newLevelNumberOfTreasures('Toses los pulmones y pierdes 2 niveles.', 2, 0, 0)
    @unusedMonsters.push Monster.new('Flecher', 2, prize, bad_consequence)
    ...
    @unusedMonsters.push Monster.new('Los hondos', 8, prize, bad_consequence)
    ...
    @unusedMonsters.push Monster.new('Semillas Cthulhu', 4, prize, bad_consequence)
    ...
    @unusedMonsters.push Monster.new('Dameargo', 1, prize, bad_consequence)
    ...
    @unusedMonsters.push Monster.new('Pollipólipo volante', 3, prize, bad_consequence)
    ...
    @unusedMonsters.push Monster.new('Yskhtihyssg-Goth', 14, prize, bad_consequence)

    # Monstruo 15 -> Familia feliz
    prize = Prize.new(3, 1)
    bad_consequence = BadConsequence.newDeath('La familia te atrapa. Estás muerto.')
    @unusedMonsters.push Monster.new('Familia feliz', 1, prize, bad_consequence)
    ...
    @unusedMonsters.push Monster.new('Roboggoth', 8, prize, bad_consequence)
    ...
    @unusedMonsters.push Monster.new('El espía sordo', 5, prize, bad_consequence)
    ...
    @unusedMonsters.push Monster.new('Tongue', 19, prize, bad_consequence)
    ...
    @unusedMonsters.push Monster.new('Bicefalo', 21, prize, bad_consequence)
  end
  ...
  def giveTreasureBack(tesoro)
    @usedTreasures.push tesoro
  end
  
  def giveMonsterBack(monstruo)
    @usedMonsters.push monstruo
  end
