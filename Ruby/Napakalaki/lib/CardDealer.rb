...
class CardDealer
  ...
  def initMonsterCardDeck
   ...
   # Monstruo 5 -> EL GORRON DEL UMBRAL
    ...
    @unusedMonster << Monster.newMonsterCultist("Testigos oculares", 6, prize, bad_consequence, 2)
        
    #sec3       
    prize = new Prize(2, 5)
    bad_consequence = DeathBadConsequence.new("Hoy no es tu dia de suerte. Mueres.", true)
    @unusedMonster << Monster.newMonsterCultist("El gran cthulhu", 20, prize, bad_consequence, 4)
